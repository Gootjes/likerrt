  ...
  expected = structure(
    list(
      A = structure(
        ...
        class = c("likerrt_likert", "haven_labelled", "numeric")
      ),
      B = structure(
        1:3,
        labels = structure(c(
        ...
        class = c("likerrt_likert", "haven_labelled", "integer")
      ),
      C = structure(
        3:1,
        labels = structure(c(
      ...
      Cr = structure(
        1:3,
        labels = structure(3:1, .Names = c("A", "B", "C")),
        class = c("likerrt_likert", "haven_labelled", "integer")
      ),
  ...
  expected =
    structure(
      list(
        ...
        D = structure(c(1, 2, 3), label = "D measure")
      ),
      row.names = c(NA,-3L),
      class = "data.frame"
    )
