...
b <-
  structure(
    c(1, 1.33, 1.67, 2, 2.33, 2.67, 3),
    label = structure("Variable A (recoded)", class = "likerrt_label"),
    labels = structure(
      c(
        `Do not agree` = 1,
        `2` = 1.33333333333333,
...
testthat::expect_error(d %>% likert_rescale(A, B, C, .min = Inf, .max = NA))
